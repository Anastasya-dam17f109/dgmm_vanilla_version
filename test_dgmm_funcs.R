...
result_filename =  paste("D:/dgmm_vanilla_version/results/output", codenum,".txt")
...
full_dgmm_res<-dgmm_labels_full(arr,arr2, classes, it, eps, init, init_est, seed)
print("============L1============")
...
print("==GMM==")
tain_cl_gmm<-gmm_labels(arr,arr2, classes, it, eps, init, init_est, seed)
...
print("==KNN==")
tain_cl<-knn_labels(arr,arr2, classes, it, eps, init, init_est, seed)
knn_labels = tain_cl
